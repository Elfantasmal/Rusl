            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <form method="POST" action="{{route('stock_out.store')}}">
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="col-md-12">
                                    <br>
                                    <table class="table table-bordered text-center">
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-md-2 text-center">出库数量</th>
                                            <th class="col-md-2 text-center">出库类型</th>
                                            <th class="col-md-2 text-center">出库时间</th>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td class="type">
                                                <input class="form-control" required name="out_type[]">
                                            </td>
                                            <td class="date">
                                                <input class="form-control" required name="out_at[]">
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
